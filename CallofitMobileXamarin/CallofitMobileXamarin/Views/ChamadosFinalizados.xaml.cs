...
namespace CallofitMobileXamarin.Views
{
	...
	public partial class ChamadosFinalizados : ContentPage
	{
        ...
        private async void loadValues()
        {
            ...
            try
            {
                ...
                var response = await chamadosService.RecuperarChamadosAsync(new BuscarChamadosRequest()
                {
                    ...
                    status_chamado_id = 3, //Finalizados
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    lstChamadosFinalizados.ItemsSource = chamadosFinalizados;
        ...
        private async void OnItemTapped(object sender, ItemTappedEventArgs e)
        {
            ...
            lstChamadosFinalizados.SelectedItem = null;
        }
    }
}