...
namespace CallofitMobileXamarin.Views
{
	...
	public partial class ChamadosEmAberto : ContentPage
	{
        ...
        private async void loadValues()
		{
            ...
            try
            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    var chamadosEmAberto = JsonConvert.DeserializeObject<List<ChamadoDTO>>(responseContent);
                    lstChamadosEmAberto.ItemsSource = chamadosEmAberto;
        ...
        private async void OnItemTapped(object sender, ItemTappedEventArgs e)
        {
            ...
            lstChamadosEmAberto.SelectedItem = null;
        }
    }
}